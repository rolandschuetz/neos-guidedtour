...
var _marked = /*#__PURE__*/regeneratorRuntime.mark(watchReady);

function watchReady() {
    return regeneratorRuntime.wrap(function watchReady$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    _context2.next = 2;
                    return (0, _effects.takeLatest)(_neosUiReduxStore.actionTypes.System.READY, /*#__PURE__*/regeneratorRuntime.mark(function ready(action) {
                        var enjoyhint_instance, enjoyhint_script_steps;
                        return regeneratorRuntime.wrap(function ready$(_context) {
                            while (1) {
...
(0, _neosUiExtensibility2.default)('CodeQ.GuidedTour', {}, function (globalRegistry) {
